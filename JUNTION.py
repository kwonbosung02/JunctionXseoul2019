...
s_img = cv2.imread('jun2.png',-1)##############::::

#많이 씀-------------------------------------------------------------------------------
prev_contours = 0
#out1 = cv2.VideoWriter('output1.mp4', -1, 20.0, (640,480))
#out1_res = cv2.VideoWriter('output_res1.mp4', -1, 20.0, (640,480))
